...
const RAW: { c: string; t: string; ty: WidgetType }[] = [
  ...
  { c: 'Characteristics & demographics', t: 'Generational breakdown',           ty: 'bar'       },
  { c: 'Characteristics & demographics', t: 'Gen Z profile',                    ty: 'pie'       },
  { c: 'Characteristics & demographics', t: 'Millennial profile',               ty: 'pie'       },
  { c: 'Characteristics & demographics', t: 'Generation X profile',             ty: 'pie'       },
  { c: 'Characteristics & demographics', t: 'Baby Boomer profile',              ty: 'pie'       },
